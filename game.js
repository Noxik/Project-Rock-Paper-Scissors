...
if (playerSelection == computerSelection) {
    ...
    round.style.cssText = 'color: ""; font-style: italic; font-weight: normal; text-decoration: underline';
 ...
 playerSelection == "Paper" && computerSelection == "Scissors") {
    compPoints++;
    selected.textContent = chose;
    round.style.cssText = "color: red; font-style: normal; font-weight: 600; text-decoration: none";
    round.textContent = `You Lose! ${computerSelection} beats ${playerSelection}! :(`;
    jsNodeText ();
} else {
    humanPoints++;
    selected.textContent = chose;
    round.style.cssText = "color: green; font-style: normal; font-weight: 700; text-decoration: none";
